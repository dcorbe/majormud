...
RAW = "../../re/oracle/oracle_charm_finish.raw"
LOG = "../../re/oracle/oracle_charm_finish_timing.log"
sfx = 2
while os.path.exists(RAW):
    RAW = f"../../re/oracle/oracle_charm_finish{sfx}.raw"
    LOG = f"../../re/oracle/oracle_charm_finish{sfx}_timing.log"
    sfx += 1
...
# --- one tight expiry ------------------------------------------------------
note("=== TIGHT EXPIRY: charm, then poll every 10s for the release ===")
room = find_kobold()
